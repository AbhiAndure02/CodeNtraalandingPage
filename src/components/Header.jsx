...
const Header = () => {
  ...
  return (
    <>
      {/* Fixed Header */}
      <header className="fixed top-0 left-0 right-0 p-2 px-6 shadow-md dark:shadow-gray-700 bg-orange-50  dark:bg-gray-800 z-50">
            ...
            <nav className='flex gap-5'>
              {['home', 'about', 'services', 'team', 'contact'].map((item) => (
                <Link 
                  ...
                  to={item} 
                  offset={-80}
                  className="text-black dark:text-white cursor-pointer font-semibold text-lg transition-all duration-300 hover:scale-105 hover:text-[#00AFB9]"
                >
